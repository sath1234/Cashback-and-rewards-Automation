...
API_URL = f"https://api.santabrowser.com/quests/bff/v1/quests/q.santa.system.usage-daily/system-status?clid={'2da68a9dd8c5a73'}"
...
def get_usage():
    try:
        ...
        # 🔥 Update these keys based on actual API response
