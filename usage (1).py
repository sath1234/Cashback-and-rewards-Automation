    ...
    with sync_playwright() as p:
        ...
        try:
            daily_usage = page.wait_for_selector(
                "//div[@class='hidden hero3:grid hero3:grid-cols-4 gap-3 items-stretch']//h3[text()='Daily Usage']",
                timeout=15000
            )
        ...
        # 🔹 CLOSE POPUP
        try:
            close_popup = page.wait_for_selector(
                "//div[@class='flex items-start gap-3 pt-2']//span[text()='Close']",
                timeout=5000
            )
