...
# 🔹 Monthly Usage XPath
MONTHLY_USAGE_XPATH = "//div[@class='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 hero3:grid-cols-4 wide:grid-cols-5 gap-2 md:gap-3']//h3[text()='Monthly Usage']"
