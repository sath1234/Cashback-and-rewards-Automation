...
# 🔹 Rank Filters
RANK_WEEKLY_XPATH = (
    "//div[@class='flex flex-wrap items-center gap-2 mb-4']//button[text()='weekly']"
)

RANK_MONTHLY_XPATH = (
    "//div[@class='flex flex-wrap items-center gap-2 mb-4']//button[text()='monthly']"
)

RANK_YEARLY_XPATH = (
    "//div[@class='flex flex-wrap items-center gap-2 mb-4']//button[text()='yearly']"
)
